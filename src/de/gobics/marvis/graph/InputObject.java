...
/**
 * An InputObject is an abstract subclass of the {@link GraphObject}. An input object
 * is some entity that has been measured from experimental context. All input object
 * contain an {@link IntensityProfile} and a weight.
 * @author Manuel Landesfeind <manuel@gobics.de>
 */

public abstract class InputObject extends GraphObject implements HasIntensity {
	/**
	 * The weight of this input object. The weight can be any type of double value
	 * and indicates some preprocessed value. It can be e.g. a p-Value.
	 */
	...
	/**
	 * A string containing the ID of this object must be given to the super class.
	 * @see GraphObject
	...
	/**
	 * Set the weight of this object. Weight has to be a double value from the interval
	 * 0 to 1 (both including).
